...
namespace WpfApplication1.Ui.TableJunction
{
    public class RowViewModel : ViewModelBase, IDisposable
    {
        ...
        public double? NodeElevation { get; }
        ...
        public RowViewModel(InfraObj objModel, string label, string associatedElementName, double? demandBase, InfraDemandPattern demandPatternModel, bool isActive, InfraZone zone, double? nodeElevation, double? demandBaseDmSet, InfraDemandPattern demandPatternModelDmSet, bool isExcluded)
        {
            ObjModel = objModel;
            Label = label;
